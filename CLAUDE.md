...
+ `docs/design/v2.1-amendments.md`（增补项 A1–A33：A1–A5 吸收自 PACT，A6–A8 吸收自
...
A29 为 Claude Design 视觉真源工序——逐页高保真稿 → 1:1 开发 → /go 5.2.6 末轮样式
...
`docs/design/pact-vs-vima-generational-assessment.md` 的共识收敛）。
